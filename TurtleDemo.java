...
public class TurtleDemo
{
    ...
    public static void drawLine()
    {
         ...
         *      Variables have a type (e.g., int, Turtle), a name (e.g., width, crush),
         *          and a value (e.g., 20, ???).
         */
        int width;      // declaring a varible
        width = 20;     // assigning a value to a variable
        int xPos = 50;  // declaring and assigning a value to a variable
         ...
         *  
         *  Mutator methods modify the state (i.e., value of attributes)
